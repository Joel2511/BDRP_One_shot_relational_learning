...
class EmbedMatcher(nn.Module):
    ...
    def __init__(self, embed_dim, num_symbols, use_pretrain=True, embed=None,
        ...
        # gating weights for 1-hop and 2-hop
        self.hop_gate = nn.Parameter(torch.FloatTensor(2))
        init.constant_(self.hop_gate, 1.0)
    ...
    def neighbor_encoder(self, connections, num_neighbors):
        ...
        neigh_vec = torch.sum(projected * attn_weights, dim=1)     # (batch, dim)
